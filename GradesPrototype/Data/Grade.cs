...
namespace GradesPrototype.Data
{
    ...
    public class Student
    {
        ...
        public bool VerifyPassword(string password) // differs from solution
        {
            if (string.Compare(password, _password)==0)
            {
                return true;
            }
            else
    ...
    public class Teacher
    {
        ...
        public bool VerifyPassword(string password) //This is differs from the solution.
        {
            if (string.Compare(password, _password) == 0)
                return true;
            else return false;
        ...
        public Teacher()
        {
            TeacherID = 0;
            UserName = String.Empty;
            Password = string.Empty; // difference between String.Empty and string.Empty?
            FirstName = string.Empty;
            LastName = string.Empty;
            Class = string.Empty;
        }
